...
internal sealed partial class CharaDataHubUi
{
    ...
    {
        _uiSharedService.BigText("ARP Character Data Online");

        DrawHelpFoldout("In this tab you can create, view and edit your own ARP Character Data that is stored on the server." + Environment.NewLine + Environment.NewLine
            + "ARP Character Data Online functions similar to the previous MCDF standard for exporting your character, except that you do not have to send a file to the other person but solely a code." + Environment.NewLine + Environment.NewLine
