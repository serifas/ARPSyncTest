...
internal sealed partial class CharaDataHubUi
{
    ...
    {
        _uiSharedService.BigText("ARPSync Character Data Online");

        DrawHelpFoldout("In this tab you can create, view and edit your own ARPSync Character Data that is stored on the server." + Environment.NewLine + Environment.NewLine
            + "ARPSync Character Data Online functions similar to the previous MCDF standard for exporting your character, except that you do not have to send a file to the other person but solely a code." + Environment.NewLine + Environment.NewLine
