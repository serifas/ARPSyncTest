...
public sealed class IpcCallerHeels : IIpcCaller
{
    ...
    public IpcCallerHeels(ILogger<IpcCallerHeels> logger, IDalamudPluginInterface pi, DalamudUtilService dalamudUtil, ARPMediator ARPMediator)
    {
        _logger = logger;
    ...
    {
        _ARPMediator.Publish(new HeelsOffsetMessage());
    }
